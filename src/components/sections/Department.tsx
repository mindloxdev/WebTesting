...
const WORKING = [
  ...
  { icon: UserRound, title: "A named account manager", detail: "One person with a direct line. Response within one business day." },
  { icon: Waypoints, title: "A clear escalation path", detail: "Account manager → RCM director → leadership, with defined response windows." },
];
