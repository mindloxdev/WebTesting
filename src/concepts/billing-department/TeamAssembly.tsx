...
/* Demo status chips — labeled Demo Data on the stage. */
const STATUS = [
  ...
  return (
    <div className="relative">
      ...
      <div className="relative flex w-[188px] flex-col items-center rounded-3xl border border-line bg-bg p-5 text-center shadow-e3">
        ...
        <p className="mt-3 font-display text-base font-semibold text-fg">[Practice Name]</p>
        <p className="font-mono text-[10px] uppercase tracking-[0.14em] text-fg-3">Your practice</p>
      </div>
    </div>
  );
}
          ...
          <div className="container-x">
            <div ref={stage} className="relative h-[min(680px,calc(100vh-120px))] overflow-hidden rounded-[28px] border border-line bg-bg-2/60">
              ...
              <motion.p
                ...
                className="absolute inset-x-0 bottom-6 mx-auto max-w-xl text-center font-display text-lg font-semibold text-fg"
              >
