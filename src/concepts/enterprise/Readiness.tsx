...
const PILLARS = [
  {
    ...
    items: [
      ...
      "Business Associate Agreements where applicable [confirm]",
      "Role-based access controls; minimum-necessary by design",
      "Audit logging on every claim touch",
      "Security documentation available on request [confirm]",
    ],
  },
  {
    icon: Building,
  ...
  },
  {
    ...
    items: [
      ...
      "Defined escalation paths and response windows [placeholder]",
