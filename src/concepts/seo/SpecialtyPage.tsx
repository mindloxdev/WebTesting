  ...
  return (
    <Frame scheme="light" theme="theme-ultimate">
      ...
      <div style={{ ["--sp" as string]: accent, ["--sp-soft" as string]: soft }}>
        ...
        <Section id="others">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <SectionHeading eyebrow="More specialties" title="Multi-specialty? We cover that too." highlight="cover that too." size="md" description="Twenty-five specialties, each with its own playbook, under one set of dashboards." />
            <Reveal className="lg:mb-2">
