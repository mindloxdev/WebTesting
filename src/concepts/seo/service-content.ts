/* ------------------------------------------------------------------ */
/*  Per-service editorial content for the ten root SEO pages.          */
/*  Domain-accurate, no fabricated statistics. [X] where a metric goes. */
/* ------------------------------------------------------------------ */
...
export const SERVICE_CONTENT: Record<string, ServiceContent> = {
  ...
  "medical-coding": {
    ...
    faq: [
      { q: "Are your coders certified?", a: "Certified coders aligned to your specialty review every encounter. [Confirm credential mix — e.g., CPC, CCS, specialty credentials — before publishing.]" },
  ...
  "payment-posting": {
    ...
    faq: [
      { q: "How fast are payments posted?", a: "835 remittances are posted the day they are received. Paper EOBs are posted within [X] business days of receipt." },
  ...
  "patient-billing": {
    ...
    faq: [
      ...
      { q: "How do you handle patient billing calls?", a: "A dedicated queue staffed by trained billing specialists who can explain a statement line by line. [Confirm hours of coverage.]" },
