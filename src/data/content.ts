...
/*  integrations, FAQ, organization types, lead-form options.          */
/*  Nothing here is a fabricated statistic.                            */
/* ------------------------------------------------------------------ */
...
export const INTEGRATIONS: Integration[] = [
  ...
  { name: "CareCloud" },
  { name: "CureMD" },
  { name: "Other PM systems", note: "confirmed during discovery" },
];
...
export const FAQ: FAQItem[] = [
  ...
  { q: "Which specialties do you support?", a: "30+ and growing, including primary care, cardiology, orthopedics, behavioral health, dermatology, urgent care, radiology, oncology, physical therapy, DME, laboratory, and telehealth. See the Specialties page for the full list." },
  ...
  { q: "How is pricing structured?", a: "Pricing depends on scope, specialty, and volume and is provided after the free revenue audit." },
  ...
  { q: "How is patient information protected?", a: "HIPAA-conscious workflows, role-based access controls, audit logging, and secure data handling. Security documentation is available on request." },
  { q: "Do you sign Business Associate Agreements?", a: "Yes, where applicable, Mindlox AI enters into BAAs with covered entities." },
