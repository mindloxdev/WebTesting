...
export default function DenialExplorerPage() {
  return (
    <Frame theme="theme-ultimate">
      <JsonLd data={breadcrumbLd([{ name: "Home", url: "https://mindlox.ai/" }, { name: "Resources", url: "https://mindlox.ai/resources" }, { name: "Denial Reason Explorer", url: "https://mindlox.ai/revenue-leakage-calculator" }])} />
      <PageHero
